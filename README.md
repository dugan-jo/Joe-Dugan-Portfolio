...
<!-- taken to google in a new webpage -->


WHEN I resize the page or view the site on various screens and devices
THEN I am presented with a responsive layout that adapts to my viewport

<!-- yes I used flex boxes as well as media queries (media and screen(max-width)) -->
```
...
This is my person portfolio page.  

I know it looks a little different form the example but:

It have 4 full page sections (width: 100vh and heigth:100vh). The nav bar is located at the top of each section.  

The webpage uses responsive flex boxes based on the size of the screen as well as media and screen(max-width) for extra responsiveness for tablets and cell phones.  

I have buttons that take you to external webpages

:hover items for each project box as well as a links
